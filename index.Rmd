---
title: "Disciplina de Métodos Estatísticos"
...
# Curso de Pós-Graduação em Ciências Veterinárias (IV/UFRRJ)  
*Métodos Estatísticos Aplicados às Ciências Veterinárias*

---

# Curso de Pós-Graduação em Medicina Veterinária (IV/UFRRJ)  
*Métodos Estatísticos Aplicados à Pesquisa Veterinária*

---

Esta página representa o repositório do conteúdo da disciplina de Métodos Estatísticos Aplicados às Ciências Veterinárias (PPGCV/IV/UFRRJ) e da disciplina de Métodos Estatísticos Aplicados à Pesquisa Veterinária (PPGMV/IV/UFRRJ)
...
| Aula |                              Descrição                               |    Data    |
|:-----------:|:--------------------------------------------:|:-----------:|
|  1   |            Apresentação da disciplina + Ambiente R + RComander       | 02/08/2025 |
|  2   |               Análise Exploratória de dados                          | 29/08/2025 |
|  3   |    Introdução à probabilidade e as principais dist. probabilidade    | 05/09/2025 |
|  4   |                           Aula de Dúvidas                            | 12/09/2025 |
|  5   |                           Primeira Avaliação                         | 19/09/2025 |
|  6   |                   Inferência Estatística - Parte 1                   | 26/09/2025 |
|  7   |                   Inferência Estatística - Parte 2                   | 03/10/2025 |
|  8   |                     Estatística não-paramétrica                      | 10/10/2025 |
|  9   |                           Aula de dúvidas                            | 17/10/2025 |
|  10  |                     Segunda Avaliação (Apresentação dos Seminários)  | 24/10/2025 |
|  11  |                     Entrega dos Relatórios                           | 31/10/2025 |

# **Aula 1:** Apresentação da disciplina + Ambiente R + RCommander 

-   Nessa aula será apresentado como será o formato da disciplina (conteúdo e dinâmica das aulas). Uma breve apresentação de como iremos utilizar a ferramenta do R no contexto da disciplina. Introdução e planejamento da coleta de dados.
...
|  Slides  | [Slide da aula 1](https://drive.google.com/file/d/1AdM_XDP4FmYirECsQWZ8Tec4bVZrGGgM/view?usp=sharing)     |
...
| Exercícios | Lista de exercícios 1                              | [link](https://drive.google.com/file/d/1A06p-eG18NAnU9HfwOG6Y4qgX1ZRB3hp/view?usp=sharing)    |
...
# **Aula 5:** Aula de Dúvidas

-   Aula destinada a sanar as dúvidas dos alunos a respeito do conteúdo apresentado até o presente momento.

# **Aula 6:** Primeira Avaliação

# **Aula 7:** Inferência Estatística - Parte 1
...
# **Aula 8:** Inferência Estatística - Parte 2
...
# **Aula 9:** Estatística não-paramétrica
...
# **Aula 10:** Aula de Dúvidas

-   Aula destinada a sanar as dúvidas dos alunos a respeito do conteúdo do curso e sobre a preparação do seminário.
...
# **Aula 12:** Entrega dos Relatórios

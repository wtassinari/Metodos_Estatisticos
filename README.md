...
| Aula |                              Descrição                               |    Data    |
|:-----------:|:--------------------------------------------:|:-----------:|
|  1   | Apresentação da disciplina                                           | 05/08/2022 |
...
- Prezados alunos, gostaríamos de pedir que preenchessem a pesquisa anônima sobre a disciplina. Todo retorno quanto ao curso é importante para nós. Procuraremos incorporar as críticas e sugestões nos próximos cursos. Agradecemos a participação e disponibilidade.**([link]())**
